...
constexpr auto SQLITE3_DEFAULT_LOOP_INTEGRAL_CONFIGURATION_TABLE = "oneloop_config";
constexpr auto SQLITE3_DEFAULT_MATSUBARAXY_CONFIGURATION_TABLE   = "Matsubara_XY_config";
constexpr auto SQLITE3_DEFAULT_GROWTH_CONFIGURATION_TABLE        = "gf_factors_config";
