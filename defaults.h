...
#define LSSEFT_DEFAULT_DIVONNE_KEY1     (47)
#define LSSEFT_DEFAULT_DIVONNE_KEY2     (11)
#define LSSEFT_DEFAULT_DIVONNE_KEY3     (1)
#define LSSEFT_DEFAULT_DIVONNE_MAXPASS  (5)
#define LSSEFT_DEFAULT_DIVONNE_BORDER   (0)
#define LSSEFT_DEFAULT_DIVONNE_MAXCHISQ (10.0)
#define LSSEFT_DEFAULT_DIVONNE_MINCHISQ (0.25)
