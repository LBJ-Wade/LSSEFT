...
#ifndef LSSEFT_FINDER_H
#define LSSEFT_FINDER_H
...
class finder
  ...
  public:
    ...
    finder&
    add_environment_variable(const std::string var, const boost::filesystem::path tail = boost::filesystem::path{});
