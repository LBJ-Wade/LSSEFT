...
void master_controller::execute()
  {
    ...
    if(!this->arg_cache.is_parameter_file_set())
      {
        this->err_handler.error(ERROR_NO_PARAMETER_FILE);
        return;
      }

    FRW_model cosmology_model(this->arg_cache.get_parameter_file_path(), WizCOLA::omega_m, WizCOLA::omega_cc,
                              WizCOLA::h, WizCOLA::T_CMB, WizCOLA::Neff, WizCOLA::f_baryon, WizCOLA::z_star,
                              WizCOLA::z_drag, WizCOLA::z_eq, WizCOLA::Acurv, WizCOLA::ns, WizCOLA::kpiv);
