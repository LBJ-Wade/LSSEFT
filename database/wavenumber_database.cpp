...
wavenumber_record::wavenumber_record(const eV_units::energy& _k, std::shared_ptr<wavenumber_token> tok)
  : k(_k),
    token(tok)
  {
  }
...
void wavenumber_database::add_record(const eV_units::energy& k, std::shared_ptr<wavenumber_token> tok)
  {
